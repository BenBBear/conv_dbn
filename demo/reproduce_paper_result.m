...
l1 = default_layer('fliplr', true, 'Nw', 10, 'num_filters', 24, 'phi_sparsity', 0.003,...
    ...
    'K_CD',1, 'sigma_start',0.2, 'std_gaussian', 0.2, 'sigma_stop', 0.1,'database','natural');
...
%Nw + batch_Nw <= rows
l3 = default_layer( 'Nw', 14, 'num_filters', 24, 'phi_sparsity', 0.005,...
    'phi_sparsity_lambda', 10, 'Npooling', 2, 'learningRate', 0.00005, 'l2reg', 0.05, ...
    'batch_size', 2, 'batch_Nw', 15, 'num_trials',1,...
